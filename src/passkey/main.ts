...
const presentPasskey = async (tenantId: string, challengeId: string, assertion: AssertCredentialResult): Promise<PasskeyAuthResult> => {
...
export const getPasskeyJwt = async (): Promise<PasskeyAuthResult> => {
